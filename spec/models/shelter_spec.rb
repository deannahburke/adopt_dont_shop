...
RSpec.describe Shelter, type: :model do
  ...
  describe 'class methods' do
    ...
    describe '.with_pending_applications' do
      it 'finds shelters with pending applications' do
    ...
    describe '.make_name_readable' do
      it 'finds shelters name using raw sql' do
        expect(Shelter.make_name_readable(@shelter_1.id)).to eq("Aurora shelter")
      end
    end

    describe '.make_city_readable' do
      it 'finds shelters city using raw sql' do
        expect(Shelter.make_city_readable(@shelter_1.id)).to eq("Aurora, CO")
      end
    end
  end
  ...
  describe 'instance methods' do
    ...
    describe '#adoptable_pets' do
      it 'count of adoptable pets at a given shelter' do
